...
from legged_gym.envs.h1_2.h1_2 import H12Robot
from legged_gym.envs.h1_2.h1_2interrupt_config import H12InterruptCfg
from copy import deepcopy

class H12InterruptRobot(H12Robot):
    def __init__(self, cfg: H12InterruptCfg, sim_params, physics_engine, sim_device, headless):
        self.cfg = cfg
